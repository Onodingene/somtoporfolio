...
const Projects = () => {
  const projects = [
    ...
    },
    {
      id: "careconnect",
      title: "CareConnect",
      description: "Web platform connecting donors with verified NGOs, featuring real-time donation tracking and impact metrics.",
    ...
    },
    {
      id: "dentup",
      title: "Dent Up",
      description: "A comprehensive web app for dental clinics enabling efficient client record and appointment management.",
      image: dentupImg,
